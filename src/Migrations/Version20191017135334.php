 ...
 */
final class Version20191017135334 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (user_id INT AUTO_INCREMENT NOT NULL, user_city_id INT DEFAULT NULL, user_name VARCHAR(50) NOT NULL, user_login VARCHAR(100) NOT NULL, user_roles JSON NOT NULL, user_birthday DATE DEFAULT NULL, user_avatar_path VARCHAR(255) DEFAULT NULL, user_temp_hash VARCHAR(50) NOT NULL, user_vk_user_id INT DEFAULT NULL, user_vk_token VARCHAR(255) DEFAULT NULL, user_vk_expires_at DATETIME DEFAULT NULL, user_Sex TINYINT(1) DEFAULT NULL, user_sc_day DATE DEFAULT NULL, user_sc_time_from TIME DEFAULT NULL, user_sc_time_to TIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D64948CA3048 (user_login), INDEX IDX_8D93D649D3A17CA5 (user_city_id), PRIMARY KEY(user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE event_party (ep_id INT AUTO_INCREMENT NOT NULL, ep_event_id INT NOT NULL, ep_status INT NOT NULL, deleted_at DATETIME DEFAULT NULL, ep_num_of_girls INT NOT NULL, ep_num_of_guys INT NOT NULL, ep_meeting_at DATETIME DEFAULT NULL, ep_meeting_place VARCHAR(255) DEFAULT NULL, INDEX IDX_C88EFFCC573B74B (ep_event_id), PRIMARY KEY(ep_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE event (event_id INT AUTO_INCREMENT NOT NULL, event_name VARCHAR(255) NOT NULL, event_desc LONGTEXT DEFAULT NULL, event_reservation_req TINYINT(1) NOT NULL, event_price VARCHAR(20) DEFAULT NULL, event_duration INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, event_address VARCHAR(100) NOT NULL, event_site VARCHAR(100) DEFAULT NULL, event_phone VARCHAR(30) DEFAULT NULL, event_yandex_map VARCHAR(255) DEFAULT NULL, event_people_min INT NOT NULL, event_people_max INT NOT NULL, PRIMARY KEY(event_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
