 ...
 */
final class Version20190524135202 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, city_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, login VARCHAR(180) NOT NULL, roles JSON NOT NULL, sex TINYINT(1) DEFAULT NULL, birthday DATE DEFAULT NULL, avatar VARCHAR(255) DEFAULT NULL, temp_hash VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649AA08CB10 (login), INDEX IDX_8D93D6498BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vk_user_extension (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, vk_user_id INT NOT NULL, token VARCHAR(255) NOT NULL, expires_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_FD08C007A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE search_criteria (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, time_from TIME NOT NULL, time_to TIME NOT NULL, day DATE DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_A6483034A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE vk_user_extension ADD CONSTRAINT FK_FD08C007A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vk_user_extension DROP FOREIGN KEY FK_FD08C007A76ED395');
        ...
        $this->addSql('DROP TABLE vk_user_extension');
